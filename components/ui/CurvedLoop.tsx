...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  return (
    ...
    >
      <svg
        className="select-none w-full overflow-visible block aspect-[6/1] text-[4.7rem] md:text-[2.5rem] xl:text-[2rem] 2xl:text-[1.5rem] tracking-[2px] uppercase leading-none"
        viewBox="0 0 1440 60"
      >
        <text
          ref={measureRef}
